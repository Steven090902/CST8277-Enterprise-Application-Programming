...
-- -----------------------------------------------------
-- Alter for Assingment 2
-- -----------------------------------------------------
ALTER TABLE `databank`.`person` ADD COLUMN `updated` BIGINT NOT NULL;
ALTER TABLE `databank`.`person` ADD COLUMN `version` BIGINT NOT NULL default 1;